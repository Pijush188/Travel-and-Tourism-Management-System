...
insert into hotel values('Raddison Blue Hotel', '3400','1000','1700','agra');
insert into hotel values('River View Hotel', '2400','1600','1000','kolkata');
insert into hotel values('The Taj Hotel', '4800','1290','2900','seerampur');
insert into hotel values('The Taj Hotel', '4800','1290','2900','raniganj');
select * from hotel;
...
alter table bookhotel add column location varchar(50);
